...
<Steps>
  <Step title="Install the SDK">
    ...
    ```bash yarn
    yarn add @lit-protocol/lit-client@beta @lit-protocol/networks@beta
    ```

    ```bash pnpm
    pnpm add @lit-protocol/lit-client@beta @lit-protocol/networks@beta
    ```

    ```bash bun
    bun add @lit-protocol/lit-client@beta @lit-protocol/networks@beta
    ```
