...
```
```bash yarn
yarn add @lit-protocol/access-control-conditions@beta
```
```bash pnpm
pnpm add @lit-protocol/access-control-conditions@beta
```
```bash bun 
bun add @lit-protocol/access-control-conditions@beta
```
</CodeGroup>
